...
from oh_my_persona.qa import build_answers
...
def test_build_answers_only_promotes_public_answers(tmp_path: Path) -> None:
    ...
    rows = [
        {"question_id": "PQ-001", "answer": "공개 답변", "answered_at": "2026-08-29", "visibility": "public"},
        {"question_id": "PQ-002", "answer": "비공개 답변", "answered_at": "2026-08-29", "visibility": "private"},
    ]
    answers.write_text("".join(json.dumps(row, ensure_ascii=False) + "\n" for row in rows), encoding="utf-8")
