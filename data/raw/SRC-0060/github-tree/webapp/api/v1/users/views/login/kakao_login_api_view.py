"""
Kakao OAuth 2.0 Login View using dj-rest-auth.

This module provides a simplified Kakao login implementation using dj-rest-auth's
built-in SocialLoginView, which leverages django-allauth's KakaoOAuth2Adapter.
...
class KakaoLoginAPIView(SocialLoginView):
  """
    Kakao OAuth 2.0 Login API View.

    This view uses dj-rest-auth's SocialLoginView with django-allauth's
    KakaoOAuth2Adapter to handle the complete OAuth flow:

    1. Receives authorization code from frontend
    2. Exchanges code for access token with Kakao
    3. Retrieves user info from Kakao
    ...
    **Important Note about redirect_uri:**
    ...
    registered in Kakao Developer Console.
    """
  ...
  @extend_schema(
    ...
    description=("Exchange Kakao authorization code for JWT tokens and user information.\n\n"
                 ...
                 "- Validates the authorization code with Kakao\n"
                 "- Creates or retrieves the user account\n"
                 "- Links the Kakao account via SocialAccount\n"
                 "- Returns JWT access and refresh tokens\n\n"
                 "**OAuth Flow:**\n"
                 "1. Frontend redirects user to Kakao OAuth authorization URL with redirect_uri\n"
                 "2. User authorizes the app on Kakao\n"
                 "3. Kakao redirects back to your redirect_uri with authorization code\n"
                 ...
                 "**Important:** The redirect_uri MUST be registered in Kakao Developer Console.\n"),
    ...
    examples=[
      OpenApiExample(
        ...
        value={"code": "KvJD8xMRvwCEz4aBGxJ5_example_code"},
        request_only=True,
      ),
      OpenApiExample(
        ...
        value={
          "code": "KvJD8xMRvwCEz4aBGxJ5_example_code",
      ...
      OpenApiExample(
        ...
        value={
          "code": "KvJD8xMRvwCEz4aBGxJ5_example_code",
          "redirect_uri": "https://myapp.com/auth/kakao/callback",
        },
        request_only=True,
      ),
      OpenApiExample(
        ...
        value={
          "code": "KvJD8xMRvwCEz4aBGxJ5_example_code",
          "redirect_uri": "myapp://auth/kakao/callback",
        },
        request_only=True,
      ),
      OpenApiExample(
  ...
  def post(self, request, *args, **kwargs):
    """
        Handle Kakao OAuth login request.

        The parent SocialLoginView handles:
        - Validating the authorization code
        - Token exchange with Kakao (using the redirect_uri)
        - User info retrieval
