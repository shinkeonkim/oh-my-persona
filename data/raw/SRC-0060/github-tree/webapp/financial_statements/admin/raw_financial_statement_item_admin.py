"""
Raw Financial Statement Item Admin
"""
from django.contrib import admin
from django.utils.html import format_html
from django.utils.translation import gettext_lazy as _

from financial_statements.models import RawFinancialStatementItem
...
@admin.register(RawFinancialStatementItem)
class RawFinancialStatementItemAdmin(ModelAdmin):
  """원본 재무제표 항목 어드민"""
  ...
  account_name_display.short_description = _("계정과목")
