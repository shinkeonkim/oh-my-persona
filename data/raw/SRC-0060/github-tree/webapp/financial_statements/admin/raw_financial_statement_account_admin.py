"""
Raw Financial Statement Account Admin
"""
...
from financial_statements.models import RawFinancialStatementAccount
from unfold.admin import ModelAdmin
from unfold.contrib.filters.admin import ChoicesDropdownFilter


@admin.register(RawFinancialStatementAccount)
class RawFinancialStatementAccountAdmin(ModelAdmin):
  """원본 재무제표 계정과목 어드민"""
  ...
  def get_queryset(self, request):
    ...
    return queryset.annotate(items_count=Count("raw_items"))

  def account_name_display(self, obj):
    """계정과목명 표시"""
    return format_html('<strong>{}</strong>', obj.account_name)
